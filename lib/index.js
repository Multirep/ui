...
let SimpleButton = class SimpleButton extends vuePropertyDecorator.Vue {
    mounted() {
...
let HelloWorld = class HelloWorld extends vuePropertyDecorator.Vue {
    msg;
};
__decorate([
...
exports.HelloWorld = __vue_component__;
exports.SimpleButton = __vue_component__$1;
